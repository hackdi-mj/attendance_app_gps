...
class _MyLocationState extends State<MyLocation> {
  ...
  UserAttendance? _userAttendance;
            ...
            children: <Widget>[
              ...
              RaisedButton(
                onPressed: () async {
                  ...
                  // //_fileName = file;
                  String objText =
                      '{"id": 0,"name": "Jumadi", "nim": "1231231321","location":"Harapan Indah","subject":"asdawdad","date":"asdawdasd"}';
                  String objText2 =
                      '{"id": 0,"name": "Muhammad", "nim": "1231231321","location":"Harapan Indah","subject":"asdawdad","date":"asdawdasd"}';

                  UserAttendance user =
                      UserAttendance.fromJson(jsonDecode(objText));
                  _writeJson(user.toString(), _controllerValue!.text);
                  print(user);
